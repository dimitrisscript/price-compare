...
export const translations: Record<string, Translations> = {
  en: {
    ...
    remove: "Remove",
    planRankingAnalysis: "🏆 Plan Ranking Analysis",
    ...
    consumptionLevel: "kWh Consumption",
    visit: "Visit",
  ...
  el: {
    ...
    remove: "Αφαίρεση",
    planRankingAnalysis: "🏆 Ανάλυση Κατάταξης Σχεδίων",
    selectPlanToAnalyze: "Επιλέξτε ένα σχέδιο για να αναλύσετε την κατάταξή του σε διαφορετικά επίπεδα κατανάλωσης:",
    ...
    bestPlan: "Καλύτερο Σχέδιο",
    bestPlanPrice: "Τιμή Καλύτερου Σχεδίου",
    ...
    consumptionLevel: "Κατανάλωση kWh",
    visit: "Επίσκεψη",
